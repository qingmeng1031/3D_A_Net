...
atc --framework=5 --model=3d_attention_net_resize_optimized.onnx --output=3d_attention_net_resize_autotune_optimized_bs16 --input_format=NCHW --input_shape="image:16,3,32,32" --log=debug --soc_version=Ascend310 